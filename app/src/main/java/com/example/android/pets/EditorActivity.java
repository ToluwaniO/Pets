...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void savePet() {
        ...
        if(petUri == null){
            Uri newRowUri = getContentResolver().insert(petUri, values);
            ...
            if (newRowUri == null) {
                ...
                Toast.makeText(this, "Pet saved with row id: " + ContentUris.parseId(newRowUri), Toast.LENGTH_SHORT).show();
            }
        }
        else {
            String whereClause = PetEntry._ID +"=?";
            String[] whereArgs = {String.valueOf(ContentUris.parseId(petUri))};

            long rowsUpdated = getContentResolver().update(petUri, values, whereClause, whereArgs);
    ...
    private void showUnsavedChangesDialog(
        ...
        builder.setMessage("Message not saved");
    ...
    private void deletePet() {
        if(petUri != null) {
            String whereClause = PetEntry._ID + "=?";
            String[] whereArgs = {String.valueOf(ContentUris.parseId(petUri))};
            int rowsDeleted = getContentResolver().delete(petUri, whereClause, whereArgs);
